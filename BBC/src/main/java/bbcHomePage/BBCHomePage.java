...
public class BBCHomePage extends WebAPI {
    ...
    public void verifyFootballScoreBtnIsNonFunctional() {
        sportbtn.click();
        boolean b = footballScore.isEnabled();
        Assert.assertTrue(b);
        String s = footballScore.getAttribute("class");
